...
async function updateWooCommerceFlowConfig() {
  ...
  try {
    ...
    // Configuración correcta con datos de Veo Veo
    const updatedNodes = [
    ...
    console.log('✅ Flujo actualizado con configuración correcta de Veo Veo\n');
    ...
    console.log('\n✅ Todos los nodos configurados y listos para usar desde el frontend');
