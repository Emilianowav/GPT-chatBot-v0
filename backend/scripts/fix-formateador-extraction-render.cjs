...
// USAR LA URI DE RENDER (PRODUCCIÓN)
...
async function main() {
  ...
  try {
    ...
    console.log('✅ Prompt de extracción actualizado en PRODUCCIÓN');
    console.log(`   Nodos modificados: ${result.modifiedCount}`);
    console.log('\n📝 NUEVO PROMPT (primeros 200 chars):');
    console.log(EXTRACTION_PROMPT.substring(0, 200) + '...');
