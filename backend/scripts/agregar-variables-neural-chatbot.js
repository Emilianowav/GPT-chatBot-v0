...
async function agregarVariablesNeuralChatbot() {
  ...
  try {
    ...
    // Conectar a la BD correcta: neural_chatbot
    ...
    // Variables globales para VeoVeo (estructura Intercapital)
