                  ...
                  <>
                    <div className={styles.webhookCreated}>
                      ...
                      <div className={styles.webhookInstructions}>
                        <h4>✓ Webhook Configured</h4>
                        <p>Connection: {config.connectionName || 'WhatsApp Business Cloud'}</p>
                        <p>Phone Number ID: {config.phoneNumberId || 'Not configured'}</p>
                        <button 
                          className={styles.reconfigureBtn}
                          onClick={() => setShowWebhookSetup(true)}
                        >
                          Reconfigure
                        </button>
              ...
              {showWebhookSetup && (
                <WebhookSetupModal
                  ...
                  onComplete={(webhookConfig) => {
                    setConfig((prev: any) => ({ ...prev, ...webhookConfig }));
