...
export default function FlowBuilderPage() {
  ...
  // Cargar flujo existente o crear uno nuevo
  useEffect(() => {
    loadFlow();
  }, []);
  ...
  const loadFlow = async () => {
    try {
      // TODO: Obtener ID del flujo desde la URL o crear uno nuevo
      const flowId = 'veo-veo-main';
  ...
  const saveFlow = async () => {
    ...
    try {
      // Convertir nodos de ReactFlow a formato del backend
      const backendNodes = nodes.map((node) => ({
        ...
        // Determinar next basado en las conexiones
        next: edges
